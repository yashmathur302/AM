...
<section class="bg-cream-50">
    <div class="pt-16 pb-6 lg:pt-24 lg:pb-10">
        <div class="w-full px-[5.5%]">
            ...
            <p data-hero-subtext class="mt-6 text-[clamp(1rem,0.92rem_+_0.35vw,1.25rem)] text-slate-600 leading-relaxed opacity-0 -translate-y-4">
            ...
            <div data-hero-ctas class="mt-8 flex flex-wrap items-center gap-x-8 gap-y-3 opacity-0 -translate-y-4">
                <a
